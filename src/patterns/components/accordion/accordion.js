...
document.addEventListener('DOMContentLoaded', function () {
    ...
    accordionGroups.forEach( (accordionGroup, group) => {
        const accordionButtons = accordionGroup.querySelectorAll('.accordion-trigger');
